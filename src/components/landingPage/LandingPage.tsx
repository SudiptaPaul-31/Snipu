...
const LandingPage = () => {
  ...
  {/* //TOP SECTION */}
    ...
    <div className='grid items-center text-center justify-around gap-4 '>
        {/* <img src={logo} alt="" /> */}
      <p className='text-sm text-[#ef9c60] my-6 '>Bitcoin Script VM in Cairo</p>
      ...
      <button className='my-20 flex  pt-2 mx-auto justify-center bg-[#36a7b9] text-3xl w-[300px] h-[50px] gap-2 rounded-full'>Let's get started<Rocket className='w-8 h-8' /></button>
...
<div className='my-20 '>
 ...
 <div className='grid mx-auto grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4'>
  <div className='bg-gradient-to-b from-[#1a2127] to-[#1a1a1a] mx-auto p-8 rounded-3xl w-[500px]' >
